...
//		// queryData := c.Copy().Request.URL.Query()
...
//			b, err := ioutil.ReadAll(cc.Request.Body)
//			cc.Request.Body = ioutil.NopCloser(bytes.NewBuffer(b))
//			if err != nil {
...
//
//		} else {
//			cc.Request.ParseMultipartForm(32 << 20)
//			for k, v := range cc.Request.PostForm {
//				//fmt.Println(k, ":", v)
//				if len(v) > 0 {
//					data[k] = v[0]
//				}
